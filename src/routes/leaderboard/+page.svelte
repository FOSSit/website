<script lang="ts">
	...
	function sortLeaderboard() {
        leaderboard.sort((a, b) => b.points - a.points); // Sort in descending order
    }
    ...
    async function loadTeams() {
        ...
        if (data.length) {
            leaderboard = data;
            sortLeaderboard(); // Sort the leaderboard after loading teams
        }
        loading = false;
    }
    ...
    async function loadIdeas() {
        ...
        if (data.length) {
            leaderboard = data;
            sortLeaderboard(); // Sort the leaderboard after loading ideas
        }
        loading = false;
    }
